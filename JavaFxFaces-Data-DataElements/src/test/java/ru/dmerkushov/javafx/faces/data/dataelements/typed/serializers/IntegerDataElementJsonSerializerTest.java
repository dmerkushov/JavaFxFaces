 ...
 * @author dmerkushov
 */
public class IntegerDataElementJsonSerializerTest {
	...
	public void test () {
		String title = "Title";
		String id = "id";
		Class elementType = IntegerDataElement.class;
		...
		IntegerDataElement sde = new IntegerDataElement (title, id, defaultValue, pp);
