 ...
 * @author dmerkushov
 */
public class JsonObjectDataElementJsonSerializerTest {
	...
	public void test () {
		String title = "Title";
		String id = "id";
		Class elementType = JsonObjectDataElement.class;
		Class valueType = JsonObject.class;
		JsonObject defaultValue = Json.createObjectBuilder ().add ("a", 1).build ();
		JsonObject currentValue = Json.createObjectBuilder ().add ("b", 2).build ();
		...
		JsonObjectDataElement sde = new JsonObjectDataElement (title, id, defaultValue, pp);
