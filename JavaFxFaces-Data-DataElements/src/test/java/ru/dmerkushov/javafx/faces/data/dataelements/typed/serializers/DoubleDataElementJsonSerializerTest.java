 ...
 * @author dmerkushov
 */
public class DoubleDataElementJsonSerializerTest {
	...
	public void test () {
		String title = "Title";
		String id = "id";
		Class elementType = DoubleDataElement.class;
		Class valueType = Double.class;
		Double defaultValue = 0.0;
		Double currentValue = 1.1;
		...
		DoubleDataElement sde = new DoubleDataElement (title, id, defaultValue, pp);
