 ...
 * @author dmerkushov
 */
public class BooleanDataElementJsonSerializerTest {
	...
	public void test () {
		String title = "Title";
		String id = "id";
		Class elementType = BooleanDataElement.class;
		Class valueType = Boolean.class;
		...
		BooleanDataElement sde = new BooleanDataElement (title, id, defaultValue, pp);
